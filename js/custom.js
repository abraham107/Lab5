...
function remClass(){
  const removingCLass=document.getElementsByClassName("carousel-control-prev");
  Element.classList.remove(removingCLass)
}


function rem2Class(){
  const removingCLass2=document.getElementsByClassName("carousel-control-next");
  Element.classList.remove(removingCLass2)
}